...
const ConsignmentItemCard = ({ i, unassignItem }: ConsignmentItemCardProps) => {
  ...
  return <div className="consignment-item-wrapper">  
    <div className="consignment-item-details">
      ...
      {unassignItem &&
        <div onClick={() => unassignItem(i)} className="absolute -left-1 -top-1 cursor-pointer">
          <svg className="max-md:w-5" width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
