...
const OrderSummary = ({ cart }: CartSummaryProps) => {
  return <div>
    ...
    <div className="cart-items">
      <div className="cart-item">
        ...
        <div style={{ width: '20%' }} className="product-price">Price</div>
      </div>
    ...
    <div style={{ marginTop: '10px', display: 'flex', justifyContent: 'space-between' }}>
      <p style={{ width: '60%', fontWeight: 'bold' }}>*Please review your order carefully-due to our baking schedule, changes cannot be made once orders are submitted. Thank you for understanding!</p>
      <div style={{ width: '40%' }}>
